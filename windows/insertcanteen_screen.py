...
class App:
    ...
    def GButton_199_command(self):  #insert
        data=(GLineEdit_624.get(),GLineEdit_824.get(),GLineEdit_992.get())
        root.destroy()
        database_controller.insertcanteen(data)

def insertcanteen_screen():
    global root
    root = tk.Toplevel()
    app = App(root)
    root.mainloop()
